                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item category-item--active">
                                    <a href="index.jsp" class="category-item__link">All</a>
                                </li>
                                <li class="category-item">
                                    <a href="gin.jsp" class="category-item__link">Gin</a>
                                </li>
                                <li class="category-item">
                                    <a href="vodka.jsp" class="category-item__link">Vodka</a>
                                </li>
                                <li class="category-item">
                                    <a href="rum.jsp" class="category-item__link">Rum</a>
                                </li>
                                <li class="category-item">
                                    <a href="champange.jsp" class="category-item__link">Champange</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
