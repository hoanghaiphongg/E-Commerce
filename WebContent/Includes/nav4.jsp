            ...
            <div class="grid wide">
                <nav class="header__navbar hide-on-mobile-tablet">
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item">
                            <a href="usermyorder.jsp"
                                class="header__navbar-item-link header__navbar-item--separate">My Order</a>
                        </li>
                        <li class="header__navbar-item">
                            <a href="userproduct.jsp"
                                class="header__navbar-item-link header__navbar-item--separate">Product</a>
                        </li>
                    ...
                    <div class="header__cart">
                        <div class="header__cart-wrap">
                            ...
                            <div class="header__cart-list">
                                ...
                                <a href="pay.jsp" class="header__cart-view-cart btn btn--primary">Pay</a>
                            </div>
                        </div>
                    </div>
                </div>
